    ...
    override public void PopulateRenderLayer()
    {
        if (_isOnStage && _firstFacetIndex != -1) {
            ...
            if (_facetTypeQuad == true) {
                ...
                _concatenatedMatrix.ApplyVector3FromLocalVector2(ref vertices[vertexIndex1], _localVertices[1], _meshZ);
                _concatenatedMatrix.ApplyVector3FromLocalVector2(ref vertices[vertexIndex2], _localVertices[2], _meshZ);
                _concatenatedMatrix.ApplyVector3FromLocalVector2(ref vertices[vertexIndex3], _localVertices[0], _meshZ);
                _concatenatedMatrix.ApplyVector3FromLocalVector2(ref vertices[vertexIndex4], _localVertices[2], _meshZ);
                _concatenatedMatrix.ApplyVector3FromLocalVector2(ref vertices[vertexIndex5], _localVertices[3], _meshZ);
