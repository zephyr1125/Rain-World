...
Shader "Futile/FlatLightBehindTerrain" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
if(dist < 6.0/30.0) return half4(0, 0, 0, 0);
...
half c = pow(pow((1-pow(centerDist , 2)), 3.5), 1);

return half4(i.clr.xyz, c * i.clr.w);
}
ENDCG
