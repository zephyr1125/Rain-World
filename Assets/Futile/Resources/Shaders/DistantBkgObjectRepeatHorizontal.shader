...
Shader "Futile/DistantBkgObjectRepeatHorizontal" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
c = tex2D(_MainTex, half2((i.uv.x/i.clr.z)/i.clr.y + _WorldCamPos.x/1400.0 + i.clr.w, i.uv.y));
//c *= i.clr;
return c;//half4(lerp(c.xyz, _AboveCloudsAtmosphereColor.xyz, i.clr.x), c.w);
}
