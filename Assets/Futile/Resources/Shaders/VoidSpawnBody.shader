...
Shader "Futile/VoidSpawnBody" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
return half4(lerp(grabCol.xyz, half3(0.529, 0.365, 0.184) * (1.0+i.clr.x), i.clr.y * i.clr.w), 1.0);
}
ENDCG
