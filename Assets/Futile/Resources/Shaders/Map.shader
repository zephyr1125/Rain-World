...
Shader "Futile/Map" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
half2 displace = normalize(i.scrPos-half2(0.5, 0.5)) * 0.275*pow(dst, 3.14);//(1-dst)*pow(dst,lerp(4,6,dst))*2;
//displace.y /= 3;
displace.y *= 0.5 / 3.0;
